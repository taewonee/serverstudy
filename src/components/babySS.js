...
function Surveysection({now, next, btn1img, btn2img, btn3img, btn4img, btn5img, demo1, demo2, demo3, demo4, demo5}) {
    ...
    const onbtn1 = e =>
        ...
        document.getElementById(demo1).style.border = "solid rgba(0, 0, 255, 0.6) 5px";
        document.getElementById(demo1).style.borderRadius = "15px";
        setAns(1);}
    const onbtn2 = e =>
        {e.preventDefault();
        switch(Ans%10) {
    ...
    const onbtn4 = e =>
        ...
        setAns(Ans + 10);
            ...
            document.getElementById(demo4).style.border = "none";
            setAns(Ans - 10);
        }
    }
    const onbtn5 = e =>
